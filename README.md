...
```bash
wget https://raw.githubusercontent.com/runtimerobotics/packt_physical_ai_workshop/main/setup_docker_ubuntu.sh && chmod +x setup_docker_ubuntu.sh && ./setup_docker_ubuntu.sh
```
